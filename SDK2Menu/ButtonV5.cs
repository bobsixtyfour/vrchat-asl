...
new string[]{"At","Idle","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet02/02-42.mp4","2","","TRUE","deaf_danielo_89"},
    ...
    static string [][][][] AllLessons = { ASLlessons, BSLlessons, DGSlessons}; //adds array of arrays into another array for easy looping. 
	...
	"Animals / Machines","Places","Stuff / Weather","Clothes / Equipment","Fantasy / Characters","Holidays / Special Days","Home stuff","Nature / Environment",
	...
	static string [][] signlanguagenames = {
		...
		new string[]{"DGS","German Sign Language (Deutsche Gebärdensprache)"}
		};
