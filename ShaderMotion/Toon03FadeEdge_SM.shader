Shader "TypeA/Toon03FadeEdge_SM"
{
	Properties
	{
		//----------------------------------------------------------------------------------------------------	
	...
	SubShader
	{
		...
		UsePass "TypeA/Toon03_SM/FORWARDBASE"
		UsePass "TypeA/Toon03Fade_SM/STENCILFADE"
		UsePass "TypeA/Toon03_SM/FORWARDADD"
		UsePass "TypeA/Toon03Fade_SM/STENCILFADEADD"
		UsePass "TypeA/Toon03Edge_SM/EDGE"
