...
{"Teach","ASL-Teach","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-01.mp4","0","0",""},{"Learn","ASL-Learn","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-02.mp4","0","0",""},{"Person","ASL-Person","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-03.mp4","0","0",""},{"Student","ASL-Student","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-04.mp4","0","0",""},{"Teacher","ASL-Teacher","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-05.mp4","0","0",""},{"Friend","ASL-Friend","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-06.mp4","0","0",""},{"Sign","ASL-Sign","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-07.mp4","0","0",""},{"Language","ASL-Language","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-08.mp4","0","0",""},{"Understand","ASL-Understand","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-09.mp4","0","0",""},{"Know","ASL-Know","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-10.mp4","0","0",""},{"Don't Know","ASL-Don't Know","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-11.mp4","0","0",""},{"Be Right Back (BRB)","ASL-Be Right Back (BRB)","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-12.mp4","0","0",""},{"Accept","ASL-Accept","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-13.mp4","0","0",""},{"Denied","ASL-Denied","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-14.mp4","0","0",""},{"Name","ASL-Name","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-15.mp4","0","0",""},{"New","ASL-New","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-16.mp4","0","0",""},{"Old","ASL-Old","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-17.mp4","0","0",""},{"Very","ASL-Very","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-18.mp4","0","0",""},{"Jokes","ASL-Jokes","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-19.mp4","0","0",""},{"Funny","ASL-Funny","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-20.mp4","0","0",""},{"Play","ASL-Play","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-21.mp4","0","0",""},{"Favorite","ASL-Favorite","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-22.mp4","0","0",""},{"Draw (Pencil)","ASL-Draw (Pencil)","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-23.mp4","0","0",""},{"Stop","ASL-Stop","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-24.mp4","0","0",""},{"Read","ASL-Read","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-25.mp4","0","0",""},{"Make","ASL-Make","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-26.mp4","0","0",""},{"Write","ASL-Write","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-27.mp4","0","0",""},{"Again / Repeat","ASL-Again / Repeat","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-28.mp4","0","0",""},{"Slow","ASL-Slow","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-29.mp4","0","0",""},{"Fast","ASL-Fast","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-30.mp4","0","0",""},{"Rude","ASL-Rude","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-31.mp4","0","0",""},{"Eat","ASL-Eat","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-32.mp4","0","0",""},{"Drink","ASL-Drink","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-33.mp4","0","0",""},{"Watch","ASL-Watch","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-34.mp4","0","0",""},{"Work","ASL-Work","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-35.mp4","0","0",""},{"Live","ASL-Live","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-36.mp4","0","0",""},{"Play Game","ASL-Play Game","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-37.mp4","0","0",""},{"Same","ASL-Same","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-38.mp4","0","0",""},{"All Right","ASL-All Right","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-39.mp4","0","0",""},{"People","ASL-People","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-40.mp4","0","0",""},{"Browsing the Internet","ASL-Browsing the Internet","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-41.mp4","0","0",""},{"Movie","ASL-Movie","No Data Yet.","https://vrsignlanguage.net/ASL_videos/sheet03/03-42.mp4","0","0",""}},
...
//Debug.Log("columnoffset="+columnoffset+" wordcolumn="+wordcolumn+" columnseperation="+columnseperation+" menusizey-headersizey-textpadding-buttonsizey="+(menusizey-headersizey-textpadding-buttonsizey)+" wordrow="+wordrow+" rowseperation="+rowseperation);
...
//also create the "selected" button with checkmark
					...
					buttontriggers.UsesAdvancedOptions=true;
							...
							new VRC_Trigger.TriggerEvent{
								...
								Events=new List<VRC_EventHandler.VrcEvent>(){
									new VRC_EventHandler.VrcEvent{
										...
										ParameterObject=GameObject.Find ("/Global Nana"),
										ParameterString="StandIdle",
									...
									new VRC_EventHandler.VrcEvent{
										...
										ParameterObject = GameObject.Find ("/Global Nana/Armature/Canvas/Bubble/text")
									},
									new VRC_EventHandler.VrcEvent{
										EventType = VRC_EventHandler.VrcEventType.SetUIText,
										ParameterString = (lessonnum+1)+"-"+(wordnum+1)+": "+AllLessons[languagenum][lessonnum][wordnum,0],
										ParameterObject = GameObject.Find ("/Global Nana/Canvas/Current Sign Panel/Current Sign Text")
									},
									new VRC_EventHandler.VrcEvent{
										EventType = VRC_EventHandler.VrcEventType.SetUIText,
										ParameterString = "This sign was recorded by: " + AllLessons[languagenum][lessonnum][wordnum,2],
										ParameterObject = GameObject.Find ("/Global Nana/Canvas/Credit Panel/Credit Text")
									},
									new VRC_EventHandler.VrcEvent{
										EventType = VRC_EventHandler.VrcEventType.SetUIText,
										ParameterString = AllLessons[languagenum][lessonnum][wordnum,6],
										ParameterObject = GameObject.Find ("/Global Nana/Canvas/Description Panel/Description Text")
									}
			...
			UnityAction<string> test = System.Delegate.CreateDelegate(typeof(UnityAction<string>), buttontriggers,"ExecuteCustomTrigger") as UnityAction<string>;
			UnityEventTools.AddStringPersistentListener(buttonoffbutton.onClick, test,"globaltrigger");
...
/*
//testing out custom trigger creation
		VRC_Trigger vrctesttrigger = langselectgo.GetOrAddComponent<VRC_Trigger>();
			vrctesttrigger.UsesAdvancedOptions = true;
			...
			customTrig.Name="mycustomtrigger";
			customTrig.TriggerType = VRC_Trigger.TriggerType.Custom;
			customTrig.TriggerIndividuals = true;
			VRC_EventHandler.VrcEvent eventAction;
			eventAction = new VRC_EventHandler.VrcEvent ();
			eventAction.EventType = VRC_EventHandler.VrcEventType.SetGameObjectActive;
			eventAction.ParameterObject = GameObject.Find ("/nana_cos01_EP");
			eventAction.ParameterBoolOp=VRC_EventHandler.VrcBooleanOp.True;
			//eventAction.ParameterInt = 1;
			customTrig.Events.Add (eventAction);
			vrctesttrigger.Triggers.Add(customTrig);

			UnityAction<string> test = System.Delegate.CreateDelegate(typeof(UnityAction<string>), vrctesttrigger,"ExecuteCustomTrigger") as UnityAction<string>;
			UnityEventTools.AddStringPersistentListener(langselectbutton.onClick, test,"mycustomtrigger");
...
/*
					//here I need to list everything with a working video, and deactivate everything execept the current one.
					...
					//i need another for loop to add every single video gameobject EXCEPT the current word.
						for(int x=0;x<AllLessons[languagenum][lessonnum].GetLength(0); x++){
							if(x!=wordnum){//exclude the one I want to play- build list of all others in the lesson.
								...
								//Debug.Log("notnull Video L"+(lessonnum+1) +" S"+(x+1));
									listofvideos.Add(
										GameObject.Find("/Menu Root/"+mode+" Menu Root/"+mode+" Video Container/"+signlanguagenames[languagenum,0]+" Video Container/"+
								signlanguagenames[languagenum,0]+" Video L"+(lessonnum+1)+"/"+
								signlanguagenames[languagenum,0]+" Video L"+(lessonnum+1) +" S"+(x+1)));
								}
								//add disable triggers to non-selected animators
								buttontriggers.Triggers[0].Events.Add(
									new VRC_EventHandler.VrcEvent{
										EventType=VRC_EventHandler.VrcEventType.AnimationBool,
										ParameterObject=GameObject.Find ("/Global Nana"),
...
Debug.Log("wordnum:"+wordnum+" count:"+listofvideos.Count);
							buttontriggers.Triggers[0].Events.Add(
								new VRC_EventHandler.VrcEvent{
									EventType=VRC_EventHandler.VrcEventType.SetGameObjectActive,
				...
				//these triggers belong on the helper gameobjects.
					...
					//i need another for loop to add every single video gameobject EXCEPT the current word.
						...
						for (int x = 0;x<arrayofvideos.GetLength(0);x++){
							...
							VRC_Trigger vrctrigger = GameObject.Find("/Menu Root/"+mode+" Menu Root/"+mode+" Trigger Container/" +signlanguagenames[languagenum,0]+ " Trigger Container/"+ 
							signlanguagenames[languagenum,0]+" " + (lessonnum+1) + "-" + (wordnum+1) +" - Trigger").GetOrAddComponent<VRC_Trigger>();//helper gameobject with vrc_trigger. 
*/
/*
						VRC_Trigger vrctrigtest = new VRC_Trigger{
							UsesAdvancedOptions=true,
